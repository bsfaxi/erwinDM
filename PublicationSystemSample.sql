...
(
	BilelRole            CHAR(9)  NOT NULL ,
	Book_Id              CHAR(9)  NOT NULL 
);

CREATE UNIQUE INDEX UPKCL_taind ON BookAuth
(BilelRole   ASC,Book_Id   ASC);

ALTER TABLE BookAuth
	ADD CONSTRAINT  UPKCL_taind PRIMARY KEY (BilelRole,Book_Id);
...
CREATE UNIQUE INDEX PK__jobs__117F9D94 ON Jobs
(Job_Id   ASC);
...
(BilelRole   ASC,Book_Id   ASC,Rylty_Id   ASC);

ALTER TABLE Rylty_Pmt
	ADD CONSTRAINT  XPKRoyalty_Payment PRIMARY KEY (BilelRole,Book_Id,Rylty_Id);
...
ALTER TABLE BookAuth
	ADD (
CONSTRAINT FK_Auth_BookAuth FOREIGN KEY (BilelRole) REFERENCES Auth (Auth_Id));
...
ALTER TABLE Emp
	ADD (
CONSTRAINT FK_Jobs_Emp FOREIGN KEY (Job_Id) REFERENCES Jobs (Job_Id));
...
ALTER TABLE Rylty_Pmt
	ADD (
CONSTRAINT FK_BookAuth_Rylty_Pmt FOREIGN KEY (BilelRole, Book_Id) REFERENCES BookAuth (BilelRole, Book_Id));
...
BEGIN
    ...
    /* ERWIN_RELATION:CHECKSUM="0000d817", PARENT_OWNER="", PARENT_TABLE="Auth"
    CHILD_OWNER="", CHILD_TABLE="BookAuth"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="FK_Auth_BookAuth", FK_COLUMNS="BilelRole" */
    SELECT count(*) INTO NUMROWS
      FROM BookAuth
      WHERE
        /*  %JoinFKPK(BookAuth,:%Old," = "," AND") */
        BookAuth.BilelRole = :old.Auth_Id;
    IF (NUMROWS > 0)
    THEN
...
BEGIN
  ...
  /* ERWIN_RELATION:CHECKSUM="00010106", PARENT_OWNER="", PARENT_TABLE="Auth"
    CHILD_OWNER="", CHILD_TABLE="BookAuth"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="FK_Auth_BookAuth", FK_COLUMNS="BilelRole" */
  IF
...
BEGIN
    ...
    /* ERWIN_RELATION:CHECKSUM="0000fc96", PARENT_OWNER="", PARENT_TABLE="BookAuth"
    CHILD_OWNER="", CHILD_TABLE="Rylty_Pmt"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="FK_BookAuth_Rylty_Pmt", FK_COLUMNS="BilelRole""Book_Id" */
    SELECT count(*) INTO NUMROWS
      FROM Rylty_Pmt
      WHERE
        /*  %JoinFKPK(Rylty_Pmt,:%Old," = "," AND") */
        Rylty_Pmt.BilelRole = :old.BilelRole AND
...
BEGIN
    ...
    /* ERWIN_RELATION:CHECKSUM="0001df4b", PARENT_OWNER="", PARENT_TABLE="Book"
    CHILD_OWNER="", CHILD_TABLE="BookAuth"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="FK_Book_BookAuth", FK_COLUMNS="Book_Id" */
    SELECT count(*) INTO NUMROWS
...
BEGIN
  ...
  /* ERWIN_RELATION:CHECKSUM="0003273f", PARENT_OWNER="", PARENT_TABLE="BookAuth"
    CHILD_OWNER="", CHILD_TABLE="Rylty_Pmt"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="FK_BookAuth_Rylty_Pmt", FK_COLUMNS="BilelRole""Book_Id" */
  IF
    /* %JoinPKPK(:%Old,:%New," <> "," OR ") */
    :old.BilelRole <> :new.BilelRole OR 
    :old.Book_Id <> :new.Book_Id
  THEN
    SELECT count(*) INTO NUMROWS
      FROM Rylty_Pmt
...
CREATE  TRIGGER  tD_Job AFTER DELETE ON Jobs for each row
-- erwin Builtin Trigger
-- DELETE trigger on Jobs 
DECLARE NUMROWS INTEGER;
BEGIN
    /* erwin Builtin Trigger */
    /* Jobs  Emp on parent delete no action */
    /* ERWIN_RELATION:CHECKSUM="0000c4ed", PARENT_OWNER="", PARENT_TABLE="Jobs"
    CHILD_OWNER="", CHILD_TABLE="Emp"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="FK_Jobs_Emp", FK_COLUMNS="Job_Id" */
    SELECT count(*) INTO NUMROWS
      FROM Emp
      WHERE
    ...
    THEN
      raise_application_error(
        -20001,
        'Cannot DELETE Jobs because Emp exists.'
      );
    END IF;
...
CREATE  TRIGGER tU_Job AFTER UPDATE ON Jobs for each row
-- erwin Builtin Trigger
-- UPDATE trigger on Jobs 
DECLARE NUMROWS INTEGER;
BEGIN
  /* erwin Builtin Trigger */
  /* Jobs  Emp on parent update no action */
  /* ERWIN_RELATION:CHECKSUM="0000ebb9", PARENT_OWNER="", PARENT_TABLE="Jobs"
    CHILD_OWNER="", CHILD_TABLE="Emp"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="FK_Jobs_Emp", FK_COLUMNS="Job_Id" */
  IF
  ...
  THEN
    ...
    THEN 
      raise_application_error(
        -20005,
        'Cannot update Jobs because Emp exists.'
      );
    END IF;
  END IF;
...
BEGIN
    /* erwin Builtin Trigger */
    /* Jobs  Emp on child insert restrict */
    /* ERWIN_RELATION:CHECKSUM="0000db3e", PARENT_OWNER="", PARENT_TABLE="Jobs"
    CHILD_OWNER="", CHILD_TABLE="Emp"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="FK_Jobs_Emp", FK_COLUMNS="Job_Id" */
    SELECT count(*) INTO NUMROWS
      FROM Jobs
      WHERE
        /* %JoinFKPK(:%New,Jobs," = "," AND") */
        :new.Job_Id = Jobs.Job_Id;
    IF (
      /* %NotnullFK(:%New," IS NOT NULL AND") */
    ...
    THEN
      raise_application_error(
        -20002,
        'Cannot insert Emp because Jobs does not exist.'
      );
    END IF;
...
BEGIN
  ...
  /* ERWIN_RELATION:CHECKSUM="00032a04", PARENT_OWNER="", PARENT_TABLE="Emp"
    CHILD_OWNER="", CHILD_TABLE="Reporting_Structure"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="FK_Employee_ReportTo", FK_COLUMNS="Rpt_To" */
  IF
  ...
  /* erwin Builtin Trigger */
  /* Jobs  Emp on child update restrict */
  ...
  THEN
    raise_application_error(
      -20007,
      'Cannot update Emp because Jobs does not exist.'
    );
  END IF;
...
BEGIN
    ...
    /* ERWIN_RELATION:CHECKSUM="00020a76", PARENT_OWNER="", PARENT_TABLE="BookAuth"
    CHILD_OWNER="", CHILD_TABLE="Rylty_Pmt"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="FK_BookAuth_Rylty_Pmt", FK_COLUMNS="BilelRole""Book_Id" */
    SELECT count(*) INTO NUMROWS
      ...
      WHERE
        ...
        :new.BilelRole = BookAuth.BilelRole AND
...
BEGIN
  ...
  /* ERWIN_RELATION:CHECKSUM="00020d0e", PARENT_OWNER="", PARENT_TABLE="BookAuth"
    CHILD_OWNER="", CHILD_TABLE="Rylty_Pmt"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="FK_BookAuth_Rylty_Pmt", FK_COLUMNS="BilelRole""Book_Id" */
  SELECT count(*) INTO NUMROWS
